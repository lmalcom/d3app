define(['jquery', 'underscore', 'backbone', 'Button'], function($, _, Backbone, Button){
	...
	var EditableSearchButton = {
		View: Button.View.extend({
			...
			template: _.template('<a class="edit">Edit</a> <div class="editText" contenteditable="true"> <%= text %> </div> <a class="delete"><img src="images/icons/x.svg"/></a><a class="add"><img src="images/icons/plus.svg"/></a>'),
			edit: function(){
				//
				if(this.filled){
